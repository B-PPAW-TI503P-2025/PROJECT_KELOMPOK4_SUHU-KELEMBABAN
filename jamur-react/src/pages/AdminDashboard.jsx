...
const AdminDashboard = () => {
  ...
  // 🔄 AUTO REFRESH STATUS PERANGKAT (POMPA, MODE, AMBANG)
  useEffect(() => {
    if (activeTab !== "dashboard") return;

    const interval = setInterval(() => {
      fetchSettings(); // <-- INI KUNCI UTAMANYA
    }, 3000); // tiap 3 detik (samakan dengan sensor kalau mau)
  ...
  return (
    ...
    >
      <div className="row">
        {/* SIDEBAR */}
        <div
          className="col-md-2 p-3 d-flex flex-column min-vh-100"
          style={{
        ...
        >
          <h4
            className="text-center mb-4 mt-2 fw-bold"
            style={{ color: "#38bdf8" }}
          >
          ...
          <div className="nav flex-column nav-pills gap-2">
            {[
              ...
              <button
                key={item.id}
                className={`nav-link text-start text-white border-0 ${
            ...
            <button
              className="nav-link text-start text-danger mt-4"
        ...
        <div className="col-md-10 p-4">
          ...
          {activeTab === "dashboard" && (
            <div className="fade-in">
              ...
              <div className="row mb-4 g-4">
                <div className="col-md-6">
                  <div
                    ...
                    style={{ ...glassStyle, borderLeft: "5px solid #f87171" }}
                  >
                ...
                <div className="col-md-6">
                  <div
                    className="p-4 h-100 d-flex align-items-center"
                    style={{ ...glassStyle, borderLeft: "5px solid #38bdf8" }}
                  >
              ...
              <div className="p-4 mb-4 shadow-lg" style={glassStyle}>
                <h5 className="mb-3">
                  <i className="bi bi-graph-up me-2"></i> Grafik Real-time
                </h5>
                ...
                <div className="col-md-7">
                  <div className="p-4 shadow-lg h-100" style={glassStyle}>
                    <h5 className="mb-4 text-warning">
                      <i className="bi bi-sliders me-2"></i> Kontrol Ambang
                      Batas
                    </h5>
                    <div className="row g-3">
                      ...
                      <div className="col-md-6">
                        ...
                        >
                          <option value="otomatis" className="text-dark">
                            OTOMATIS (IoT)
                          </option>
                          <option value="manual" className="text-dark">
                            MANUAL (User)
                          </option>
                        </select>
                      </div>
                ...
                <div className="col-md-5">
                  <div className="p-4 shadow-lg h-100" style={glassStyle}>
                    <h5 className="mb-4 text-info">
                      <i className="bi bi-broadcast me-2"></i> Status Perangkat
                    </h5>
                    ...
                    <div className="d-flex justify-content-between align-items-center border-bottom border-secondary pb-3 mb-3">
                      ...
                      <span
                        className={`fw-bold ${
                          settings?.pump_status ? "text-success" : "text-danger"
                        }`}
                      >
                        {settings?.pump_status ? (
                          ...
                          <span>
                            <i className="bi bi-x-circle-fill me-1"></i> MATI
                            (STANDBY)
                          </span>
                        )}
                      </span>
          ...
          {activeTab === "add_user" && (
            <div
              className="p-5 mx-auto shadow-lg"
              style={{ ...glassStyle, maxWidth: "600px" }}
            >
              <h3 className="text-success mb-4 text-center">
                <i className="bi bi-person-plus-fill me-2"></i> Daftarkan Petani
              </h3>
              <form onSubmit={handleRegister}>
                ...
                <button
                  type="submit"
                  className="btn btn-success w-100 py-2 mt-3 fw-bold"
                >
                  Simpan Akun
                </button>
              </form>
